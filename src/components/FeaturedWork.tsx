      ...
      <div className="grid gap-3 sm:gap-4 xl:grid-cols-[1.55fr_1fr]">
        <article className="flex flex-col overflow-hidden rounded-[1.25rem] border border-line bg-card">
          ...
          <div className="flex flex-1 flex-col p-6 md:p-7">
            ...
            <h2 className="mt-2 font-serif text-3xl leading-tight">{site.title}</h2>
        ...
        <article className="flex flex-col overflow-hidden rounded-[1.25rem] border border-line bg-card">
          ...
          <div className="flex flex-1 flex-col p-6 md:p-7">
            ...
            <h2 className="mt-2 font-serif text-3xl leading-tight">{workflow.title}</h2>
      ...
      <div className="panel">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 font-serif text-3xl leading-tight md:text-4xl">Live client sites.</h2>
          </div>
